...
protected:
    ...
    static constexpr char BOOL_TYPE    {0x00};
    static constexpr char STR_TYPE     {0x01};
    static constexpr char INT_TYPE     {0x10};
    static constexpr char NEW_LINE_TYPE{0x11};
    
    static constexpr char HEADER_LENGTH_IN_BYTES{1};

    static constexpr char INT_ID_BIT_POS {3};
    static constexpr char INT8_ID  {0x00};
    static constexpr char INT16_ID {0x01};
    static constexpr char INT32_ID {0x10};
    static constexpr char INT64_ID {0x11};
    ...
    static const std::map<uint16_t, char> NUMBER_OF_BITS_TO_INT_ID;
};
